...
/*!
    ../embedded-widgets-1.1.0/src/svgtoggleswitch/qtsvgtoggleswitch.cpp
    Destructor
*/
...
void QtSvgToggleSwitch::setLockalSkin(const QString& path,const QString& skin)
{
    m_skin = skin;
    const QString base = path + skin + '/';
...
QRect QtSvgToggleSwitch::buttonRect() const
{
    ...
    buttonSize.scale(size(), Qt::IgnoreAspectRatio);
